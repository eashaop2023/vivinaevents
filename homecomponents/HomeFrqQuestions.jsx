...
const faqData = [
  {
    question: "What exactly is Flashoot?",
    answer:
      "Flashoot is an real-time content creation platform where you can book trained iPhone creators (called Flashooters) who shoot, edit,and deliver reels withib 10 minutes-- perfect for creators, brands, weddings, and events.",
  },
  {
    question: "How is it different from hiring a regular videographer?",
    answer:
      "Unllike traditional services, Flashoot is fast, affordable, and reliable. We deliver professional-grade reels instantly, all shot on iPhone by certified creators who go through a 6-step training and evalution process.",
  },
  {
  ...
  {
    question: "Can I book a specific creator or a female Flashooter?",
    answer:
      "Yes, you can request a prefferred Flashooter or a afemale creator while booking. Subject to availability.",
  },
  {
  ...
  {
    question: "Can I directly contact the Flashooter after booking?",
    answer:
      "No. For coordination or changes, always reach out to the Flashoot team. Please do not contact Flashooters directly. ",
  },
  {
    question: "Do you operate okutside India?",
    answer:
      "Yes, Flashoot is currently active in India, UAE, with city-specific availability.",
  },
  {
    question: "What kind of shoots does Flashoot handle?",
     answer:`• Weddings 
     • Brand campaingns 
     •Restaurant or product reels
     • Indluencer content
     • College & cultural fests
     • Personal moments (birthdays, surprises, etc.)`,
  },
];
