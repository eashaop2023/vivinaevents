...
//       <div
//         className="absolute inset-0 bg-cover bg-center scale-110 animate-[bgMove_30s_ease-in-out_infinite]"
...
//           </h1>
//           <p className="mt-4 text-gray-300 max-w-xl leading-relaxed">
//             ProShoot • Décor • Catering • Entertainment
//           </p>
//         </div>
...
//           <button
//             onClick={() => navigate("/events")}
//             className="px-9 py-3 bg-red-600 hover:bg-red-700 text-white rounded-full text-lg font-semibold transition"
//           >
//             Events
//           </button>
...
//           <button
//             onClick={() => navigate("/proshoot")}
//             className="px-8 py-3 border border-white/40 text-white hover:bg-white hover:text-black rounded-full text-lg font-semibold transition"
//           >
//             ProShoot
//           </button>
//         </div>
