...
const testimonials = [
  ...
  {
    text: "Seamless booking, professional creators, and stunning reels! Flashoot made capturing memories effortless and fun.",
    name: "Abhiram Kukunuri",
    img: "https://randomuser.me/api/portraits/men/32.jpg",
  },
  {
    text: "Highly impressed with Flashoot! Easy to use, top-notch reel makers, and fantastic results. Will book again!",
    name: "Prem Kumar",
  ...
  {
    text: "Capturing moments has never been easier! Flashoot connects you with skilled reel makers for perfect event videos.",
    name: "Sri Sharan",
