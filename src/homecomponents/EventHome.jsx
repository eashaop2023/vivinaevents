...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#2b0006] via-[#4b000a] to-[#2b0006] text-white px-35 py-30">
...
//         <button className="custom-prev w-10 h-10 rounded-full border border-red-500
//                            flex items-center justify-center hover:bg-red-500 transition">
//           <ArrowBackIosNewIcon fontSize="small" />
//         </button>

//         <button className="custom-next w-10 h-10 rounded-full border border-red-500
//                            flex items-center justify-center hover:bg-red-500 transition">
//           <ArrowForwardIosIcon fontSize="small" />
//         </button>
//       </div>

//       {/* EVENTS SLIDER WITH ARROWS */}
//       <Swiper
//         modules={[Autoplay, Navigation]}
//         navigation
...
//                 <h3 className="font-semibold text-red-400 text-center">
//                   What’s Included
//                 </h3>
...
//                 <button
//                   onClick={() => navigate(`/events/${item.id}`)}
//                   className="mt-5 mx-auto flex items-center gap-1 
