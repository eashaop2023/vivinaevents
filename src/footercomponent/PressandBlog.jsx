...
const pressData = [
  {
    ...
    desc:
      "Flashoot has successfully raised ₹24 million in its second round of funding at a valuation of ₹220 million. The latest capital infusion will fuel Flashooot's expansion plans across multiple Indian vities...",
    date: " March 25, 2025",
  },
  {
  ...
  },
  {
    ...
    desc:
      "Founded by Voleti Karthik, Manikanta Bukka, and Shreyak Singh, Flashoot is poised to disrupt the digital content creation industry by simplifying the process of sourcing and collaboating with talented reel-makers...",
    date: " July 17, 2024",
  },
];
    ...
    >
      ...
      <div className="text-center mb-20">
        ...
        <p className="mt-4 text-white/75 max-w-xl mx-auto text-base">
          Discover how Flashoot is making waves in the content creation industry
        </p>
      </div>
